...
(function() {
    ...
    var sceneURL = params.load ? params.load : '__URL__360player.gltf'.replace('__URL__', '');
    if (!sceneURL) {
...
function prepareExternalInterface(app) {
    ...
    // }
    app.ExternalInterface.enableGyro = function() {
        app.controls = new v3d.DeviceOrientationControls( app.camera );
    };
    
    app.ExternalInterface.disableGyro = function() {
        app.enableControls();
    }
}
...
function runCode(app) {
    ...
    console.log("作者：宅家呗 https://zjbcool.com"); 
}
